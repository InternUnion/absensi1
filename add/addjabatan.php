                                    ...
                                    <div class="col-lg-7">
                                        <div class="p-5">
                                            ...
                                            <div class="text-center">
                                                <img src="../template/Admin/horizontal/assets/images/404-error.svg" alt="error" height="140">
                                            ...
                                            <div class="row mt-4">
                                                <div class="col-12 text-center">
                                                    <a href="../page/dashboard.php" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-home mr-2"></i>Back to Home </a>
                                                </div> <!-- end col -->
                                            </div>
                                            <!-- end row -->
                                        </div> <!-- end .padding-5 -->
