                        ...
                        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                            ...
                            <div class="collapse navbar-collapse" id="topnav-menu-content">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link active" href="../add/adduser.php" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-subtitle mb-4">Insert Data Users</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <?php
                                            ...
                                            while($datausers = mysqli_fetch_array($query)) {
                                            $i++;
                                        ?>
                                            <tr>
                                                <td><?php echo $i;?></td>
                                                ...
                                                <td><center><a href="#"  class="btn btn-warning" name="edit"><i class=" fas fa-wrench"></i></a> | 
                                                        <a href="" class="btn btn-danger" ><i class="fas fa-trash"></i></a></center></td>
